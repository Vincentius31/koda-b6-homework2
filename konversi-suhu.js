...
rl.question("Masukan nilai: ", (inputNilai) =>{
    rl.question("Masukan satuan awal: ", (inputSatuanAwal) =>{
        rl.question("Masukan satuan tujuan: ", (inputSatuanTujuan) =>{
            temp = Number(inputNilai)
            tempSource = inputSatuanAwal
            convertTo = inputSatuanTujuan
